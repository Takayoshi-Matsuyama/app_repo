...
| (4) 偽陰性率 | $P(A^{c}\|H_1) = 1 - P(A\|H_1)$ | 0.3 |

事後確率

| 項目 | 式 | 計算 (ベイズの定理より) | 値 |
| --- | --- | --- | --- |
| 陽性で疾患あり(真陽性) | $P(H_1\|A)$ | $\dfrac{P(H_1)P(A\|H_1)}{P(H_1)P(A\|H_1) + P(H_2)P(A\|H_2)} = \dfrac{0.001 \times 0.7}{0.001 \times 0.7 + 0.999 \times 0.01}$ | 0.065 (6.5%) |
| 陽性だが疾患なし(偽陽性) | $P(H_2\|A)$ | $\dfrac{P(H_2)P(A\|H_2)}{P(H_1)P(A\|H_1) + P(H_2)P(A\|H_2)} = \dfrac{0.999 \times 0.01}{0.001 \times 0.7 + 0.999 \times 0.01}$ | 0.935 (93.5%) |
| 陰性で疾患なし(真陰性) | $P(H_2\|A^{c})$ | $\dfrac{P(H_2)P(A^{c}\|H_2)}{P(H_1)P(A^{c}\|H_1) + P(H_2)P(A^{c}\|H_2)} = \dfrac{0.999 \times 0.99}{0.001 \times 0.3 + 0.999 \times 0.99} $ | 0.9997 (99.97%) |
| 陰性だが疾患あり(偽陰性) | $P(H_1\|A^{c})$ | $\dfrac{P(H_1)P(A^{c}\|H_1)}{P(H_1)P(A^{c}\|H_1) + P(H_2)P(A^{c}\|H_2)}= \dfrac{0.001 \times 0.3}{0.001 \times 0.3 + 0.999 \times 0.99} $ | 0.0003 (0.03%) |
